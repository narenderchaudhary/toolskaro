...
export default function Page() {
  const jsonLd = {
    ...
    "@graph": [
      { "@type": "SoftwareApplication", name: "JPG to PDF Converter", applicationCategory: "BusinessApplication", operatingSystem: "Web", offers: { "@type": "Offer", price: "0", priceCurrency: "USD" } },
  ...
  return (
    <>
      ...
      <RelatedTools
        ...
        hrefs={["/pdf/pdf-to-jpg/", "/pdf/merge/", "/pdf/compress/", "/resize-pdf/"]}
      />

      <RecentTools current="/pdf/jpg-to-pdf/" />
