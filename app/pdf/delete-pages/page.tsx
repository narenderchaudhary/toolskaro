...
export default function Page() {
  const jsonLd = { "@context": "https://schema.org", "@graph": [
    { "@type": "SoftwareApplication", name: "Delete PDF Pages", applicationCategory: "BusinessApplication", operatingSystem: "Web", offers: { "@type": "Offer", price: "0", priceCurrency: "USD" } },
  ...
  return (
    <>
      ...
      <div className="tool-shell"><DeletePages /></div>
      ...
      <RelatedTools
        ...
        hrefs={["/pdf/split/", "/pdf/merge/", "/pdf/rotate/", "/pdf/compress/"]}
      />
      <RecentTools current="/pdf/delete-pages/" />
      <Faq items={faqs} />
    </>
  );
}
