...
export const metadata: Metadata = {
  ...
  description:
    "Resize and compress your photo and signature for a PAN card application (Form 49A) online for free. Hit the size and KB the NSDL / UTIITSL form needs — 100% in your browser.",
  ...
  return (
    <>
      ...
      <div className="tool-hero">
        ...
        <p className="lede">Size and compress your photo and signature for a PAN card application (Form 49A) — free, no signup, in your browser.</p>
      </div>
      ...
      <div className="card content">
        ...
        <p>
          Upload your photo above and compress it to the KB your PAN form needs. To set exact centimetre
          dimensions first, use <a href="/resize-image-in-cm/">resize in cm</a> (3.5×2.5&nbsp;cm), size
          your signature with <a href="/signature-resize/">Signature Resize</a>, and get a clean
          white-background photo from the <a href="/passport-photo-maker/">Passport Photo Maker</a>.
          Everything runs in your browser, so your documents stay private.
        </p>
      </div>
