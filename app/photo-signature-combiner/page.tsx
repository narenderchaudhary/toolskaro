...
const faqs = [
  { q: "Why do some forms need photo and signature in one image?", a: "Certain exam and application portals ask you to upload a single combined image containing both your photograph and signature. This tool creates exactly that." },
...
export default function Page() {
  const jsonLd = {
    ...
    "@graph": [
      { "@type": "SoftwareApplication", name: "Photo & Signature Combiner", applicationCategory: "MultimediaApplication", operatingSystem: "Web", offers: { "@type": "Offer", price: "0", priceCurrency: "INR" } },
  ...
  return (
    <>
      ...
      <div className="tool-hero">
        ...
        <p className="lede">Join your photo and signature into one image for exam forms — free, no upload, 100% in your browser.</p>
      </div>
      <PhotoSign />
      ...
      <div className="card content">
        ...
        <p>
          A number of Indian exam and job application portals ask candidates to upload a single image
