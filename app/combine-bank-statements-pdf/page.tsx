...
export const metadata: Metadata = {
  ...
  description:
    "Merge multiple bank statements into one PDF for free. Combine monthly statements into a single file for visa, loan or rental applications — no sign-up, 100% in your browser, never uploaded.",
  ...
  return (
    <>
      ...
      <div className="tool-hero">
        ...
        <p className="lede">Merge several monthly statements into a single file for visa, loan or rental applications — free, no sign-up, and 100% in your browser so your bank data stays private.</p>
      </div>
      ...
      <div className="card content">
        ...
        <p>
          Add your statement PDFs, put them in order, and merge. Because <strong>nothing is uploaded</strong>,
