...
export default function Page() {
  const jsonLd = {
    ...
    "@graph": [
      { "@type": "SoftwareApplication", name: "Social Media Image Resizer", applicationCategory: "MultimediaApplication", operatingSystem: "Web", offers: { "@type": "Offer", price: "0", priceCurrency: "INR" } },
