...
export default function Page() {
  const jsonLd = {
    ...
    "@graph": [
      { "@type": "SoftwareApplication", name: "Marriage Biodata Maker", applicationCategory: "BusinessApplication", operatingSystem: "Web", offers: { "@type": "Offer", price: "0", priceCurrency: "USD" } },
