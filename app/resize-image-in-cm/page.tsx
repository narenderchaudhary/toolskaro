...
const faqs = [
  ...
  { q: "What DPI should I use to resize a photo in cm?", a: "Use 300 DPI for printing and exam or passport forms — it is the standard most portals expect. Choose 96 DPI only when the image will be viewed on screen and never printed." },
  ...
  return (
    <>
      ...
      <div className="tool-hero">
        ...
        <p className="lede">Resize a photo in cm with DPI — set the exact width and height in centimetres at 300 DPI for passport, exam and print sizes. Free, instant and 100% in your browser.</p>
      </div>
      ...
      <div className="card content">
        ...
        <p>
          ...
          exam and passport photos, keep the DPI at <strong>300</strong> — resizing a photo in cm with
