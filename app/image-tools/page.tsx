...
export const metadata: Metadata = {
  title: "Free Image Tools — Resize, Compress & Edit Photos Online",
  description:
...
const faqs = [
  { q: "Which image tool do I need for an online form?", a: "Most online forms need a passport-style photo and a signature at exact pixel sizes and KB limits. Use the Image Resizer to set the dimensions, the Image Compressor to hit the KB target (often 20–50 KB), the Passport Photo Maker for a white background, and Signature Resize for the signature." },
  ...
  { q: "What image formats are supported?", a: "The tools work with common formats like JPG, PNG and WebP. The Image Converter lets you switch between PNG, JPG and WebP, and most tools export a JPG or PNG suitable for online application portals." },
];
...
export default function Page() {
  return (
    <Hub
      catKey="image"
      heading="Free Image Tools for Forms & Everyday Files"
      headingNode={<>Free <span className="grad">Image Tools</span> for Forms &amp; Everyday Files</>}
      lede="Resize, compress, crop and convert your photo and signature to the exact size many online forms need — free, no sign-up, 100% in your browser."
      faqs={faqs}
    >
      <h2 style={{ marginTop: 0 }}>Everything you need to prepare a photo & signature</h2>
      <p>
        Online application portals are strict about images: your photograph and signature must be a
      ...
      <p>
        Beyond form prep you can <Link href="/remove-background/">remove a photo background</Link>,{" "}
        ...
        a specific format? Try the ready-made{" "}
        <Link href="/photo-resize-for-ssc-cgl/">SSC CGL</Link> and{" "}
        <Link href="/photo-resize-for-upsc/">UPSC</Link> photo presets. Every tool runs locally, so your
